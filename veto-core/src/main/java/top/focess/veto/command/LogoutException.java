 ...
 *
 * <p>Thrown by command handlers (e.g. {@code /logout}) to indicate a voluntary logout.
 * {@link CommandRegistry} catches this exception during dispatch and
 * converts it into an {@link IpcFrame.Done} frame carrying
 * {@link IpcMeta#CLEAR_SESSION} metadata, which instructs the terminal
