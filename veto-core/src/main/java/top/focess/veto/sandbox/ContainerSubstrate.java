...
public final class ContainerSubstrate implements SandboxSubstrate {
    ...
    public SandboxHandle provision(SandboxProfile profile) {
        throw new UnsupportedOperationException(
                "ContainerSubstrate is Phase-2 (out of MVP scope): requires Docker Engine");
    }
    ...
    public CommandResult runCommands(
        ...
        throw new UnsupportedOperationException("ContainerSubstrate is Phase-2 (out of MVP scope)");
    }
