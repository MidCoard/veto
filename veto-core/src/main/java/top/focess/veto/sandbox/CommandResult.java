...
/**
 * The result of a {@code run_command} chain. Transcribed from {@code
 * container_sandbox_isolation.md} §3.
 *
 ...
 */
public record CommandResult(int exitCode, String stdout, String stderr, List<Integer> perCommand) {
