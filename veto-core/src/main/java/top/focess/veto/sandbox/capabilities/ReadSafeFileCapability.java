...
/**
 * Atomic capability: read_safe_file. Reads a file's contents with strict path traversal protection.
    ...
    public String execute(ToolExecutionRequest request) throws SecurityException {
        ...
        try {
            ...
            return String.format(
                    ...
                    resolved.getFileName().toString(), content.length(), escapeJson(content));
        } catch (IOException e) {
