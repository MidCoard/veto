...
@ToolDoc(
        ...
        returnExamples = {
            ...
            "Tool execution failed: outcome must be complete, partial, or not_found. Correct all listed fields together. Choose supporting evidence and keep the answer within its scope; exact quotations are attached from evidenceIds. Combine related limitations."
        },
        examples = {
