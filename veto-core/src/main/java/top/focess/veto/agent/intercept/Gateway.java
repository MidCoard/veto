...
public class Gateway {
    ...
    /**
     * Screens one native/remote tool call. Runs deterministic checks only (Part 3.1); the SLM
     * semantic screen is Phase-2. Returns a typed {@link Verdict}; the {@link HitlRegistry} decides
     * {@link ApprovalDecision} from it.
     */
