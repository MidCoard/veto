 ...
 * implemented</b>: the tool is registered (advertised + audited through the {@link McpEngine} path)
 * but spawning is not enabled — execution returns a not-implemented observation.
 */
