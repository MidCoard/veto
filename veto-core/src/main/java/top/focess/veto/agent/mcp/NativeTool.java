 ...
 * structured parameters) must be annotated with {@link ToolSecurity} to declare its risk category,
 * and each parameter record component may carry a {@link SecurityHint} so the Gateway knows how to
 * screen individual arguments.
 *
