...
class DefaultUniformLLMCallerTest {
    ...
    private @NonNull LlmEgress egressReturning(@NonNull String apiKey) {
        LlmEgress egress = mock(top.focess.veto.agent.tool.ToolDocs.nonNullClass(LlmEgress.class));
    ...
    void delegatesToSupportingProvider() {
        LLMProviderStrategy s1 =
                mock(top.focess.veto.agent.tool.ToolDocs.nonNullClass(LLMProviderStrategy.class));
    ...
    void throwsWhenNoProviderSupportsType() {
        ...
        assertThrows(
                top.focess.veto.agent.tool.ToolDocs.nonNullClass(ModelCapabilityException.class),
    ...
    void doesNotRetryNonRetryableFailure() {
        ...
        DefaultUniformLLMCaller caller =
                new DefaultUniformLLMCaller(List.of(s), egressReturning("secret"));
        assertThrows(
                top.focess.veto.agent.tool.ToolDocs.nonNullClass(LlmException.class),
