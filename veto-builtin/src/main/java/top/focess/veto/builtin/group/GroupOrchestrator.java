...
public class GroupOrchestrator {
    ...
    private static final @NonNull Logger log =
            LoggerFactory.getLogger("top.focess.veto.builtin.group.GroupOrchestrator");
    ...
    private final @NonNull Set<UUID> closingGroups = ConcurrentHashMap.newKeySet();
    ...
    private Group tickInner(@NonNull UUID groupId) {
        ...
        if (!group.isActive() || closingGroups.contains(groupId)) {
            return group;
        }
