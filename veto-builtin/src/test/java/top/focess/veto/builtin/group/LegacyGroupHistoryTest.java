...
import top.focess.veto.builtin.group.LegacyGroupHistory.SessionRecord;
...
class LegacyGroupHistoryTest {
    private static @NonNull SessionRecord record(
        ...
        return recordValue("leader", n, type, payload, Instant.ofEpochSecond(n), false, 20, 0);
    }
    ...
    private static @NonNull SessionRecord recordValue(
            ...
            int input,
            int output) {
        return new SessionRecord(agent, type, turn, at, payload);
    }
}
