...
public class SandboxConfiguration {
    ...
    private List<String> allowedCapabilities = List.of(
        "read_safe_file", "compile_cpp_target", "list_directory", "diff_text_files", "search_in_files"
    );
    ...
    public boolean isForbidGenericShell() { return forbidGenericShell; }
    public void setForbidGenericShell(boolean forbidGenericShell) { this.forbidGenericShell = forbidGenericShell; }
