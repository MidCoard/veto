...
/**
 * C6 Atomic Capability Interface - defines a single, atomic tool execution capability. Each
 * capability performs exactly one type of OS operation, with strict input validation. No generic
 * command injection (run_bash, exec_raw) is allowed.
 */
