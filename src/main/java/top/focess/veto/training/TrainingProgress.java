...
/**
 * Represents the current state of a model training run.
 * Thread-safe; read by the REST controller for monitoring.
 */
public class TrainingProgress {
    ...
    public String getTrainedModelPath() { return trainedModelPath; }
    public Instant getStartedAt() { return startedAt; }
    public Instant getCompletedAt() { return completedAt; }
    public String getErrorMessage() { return errorMessage; }
    public EvaluationReport getEvaluation() { return evaluation; }

    public void setEvaluation(EvaluationReport evaluation) { this.evaluation = evaluation; }
    ...
    public record EvaluationReport(
        ...
        public record RedactionAccuracy(int truePositives, int falsePositives,
                                         int falseNegatives, double precision,
