...
/**
 * Configuration for the Veto Model Training Pipeline.
 * Controls Python subprocess paths, model selection, and output destinations.
 */
@Configuration
...
public class TrainingConfiguration {
    ...
    public String getTrainingDir() { return trainingDir; }
    public void setTrainingDir(String trainingDir) { this.trainingDir = trainingDir; }

    public String getModelOutputDir() { return modelOutputDir; }
    public void setModelOutputDir(String modelOutputDir) { this.modelOutputDir = modelOutputDir; }

    public String getBaseModel() { return baseModel; }
    public void setBaseModel(String baseModel) { this.baseModel = baseModel; }

    public String getDefaultGgufName() { return defaultGgufName; }
    public void setDefaultGgufName(String defaultGgufName) { this.defaultGgufName = defaultGgufName; }

    public int getMaxTrainingHours() { return maxTrainingHours; }
    public void setMaxTrainingHours(int maxTrainingHours) { this.maxTrainingHours = maxTrainingHours; }

    public boolean isAutoDeployOnCompletion() { return autoDeployOnCompletion; }
    public void setAutoDeployOnCompletion(boolean autoDeployOnCompletion) { this.autoDeployOnCompletion = autoDeployOnCompletion; }

    public String getVenvPath() { return venvPath; }
    public void setVenvPath(String venvPath) { this.venvPath = venvPath; }

    public boolean isRestartBridgeOnDeploy() { return restartBridgeOnDeploy; }
    public void setRestartBridgeOnDeploy(boolean restartBridgeOnDeploy) { this.restartBridgeOnDeploy = restartBridgeOnDeploy; }
}
