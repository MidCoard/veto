...
/**
 * C4 MCP Extensibility Engine - top-level service. Implements the Model Context Protocol for
 * dynamic discovery and mounting of local/enterprise MCP Servers. Third-party plugins run within
 * WASM sandboxes.
 */
@Service
