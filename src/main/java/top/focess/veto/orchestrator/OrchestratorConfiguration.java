...
public class OrchestratorConfiguration {
    ...
    public long getWorkerIdleTimeoutMs() { return workerIdleTimeoutMs; }
    public void setWorkerIdleTimeoutMs(long workerIdleTimeoutMs) { this.workerIdleTimeoutMs = workerIdleTimeoutMs; }
