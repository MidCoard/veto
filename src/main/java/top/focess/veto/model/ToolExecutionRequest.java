...
public class ToolExecutionRequest {
    ...
    public ToolExecutionRequest(String id, String capabilityName, Map<String, Object> arguments,
                                Set<String> requiredCredentials, String sessionId, String workflowId) {
        this.id = id;
        this.capabilityName = capabilityName;
        this.arguments = arguments != null ? Collections.unmodifiableMap(new HashMap<>(arguments)) : Map.of();
        this.requiredCredentials = requiredCredentials != null ? Collections.unmodifiableSet(new HashSet<>(requiredCredentials)) : Set.of();
    ...
    public Set<String> getRequiredCredentials() { return requiredCredentials; }
    public String getSessionId() { return sessionId; }
    public String getWorkflowId() { return workflowId; }
    public Instant getCreatedAt() { return createdAt; }
    public synchronized ToolExecutionStatus getStatus() { return status; }
    public synchronized String getResultPayload() { return resultPayload; }
    ...
    public String toString() {
        return "ToolExecutionRequest{id='" + id + "', capability='" + capabilityName + "', status=" + status + "}";
    }
}
