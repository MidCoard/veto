...
public class DAGPayload {
  ...
  public DAGPayload(
    ...
    this.parameters =
        parameters != null ? Collections.unmodifiableMap(new HashMap<>(parameters)) : Map.of();
    this.dependencies =
        dependencies != null ? Collections.unmodifiableSet(new HashSet<>(dependencies)) : Set.of();
