...
public class VetoGatewayConfiguration {
    ...
    public LlamaCppConfig getLlamaCpp() { return llamaCpp; }
    public void setLlamaCpp(LlamaCppConfig llamaCpp) { this.llamaCpp = llamaCpp; }
    public boolean isInterceptAllOutbound() { return interceptAllOutbound; }
    public void setInterceptAllOutbound(boolean interceptAllOutbound) { this.interceptAllOutbound = interceptAllOutbound; }
    ...
    public boolean isEnforceStructuralConstraints() { return enforceStructuralConstraints; }
    public void setEnforceStructuralConstraints(boolean enforceStructuralConstraints) { this.enforceStructuralConstraints = enforceStructuralConstraints; }
    ...
    public static class LlamaCppConfig {
        ...
        public String getGbnfGrammarPath() { return gbnfGrammarPath; }
        public void setGbnfGrammarPath(String gbnfGrammarPath) { this.gbnfGrammarPath = gbnfGrammarPath; }
    }
}
