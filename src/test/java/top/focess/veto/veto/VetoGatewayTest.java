...
class VetoGatewayTest {
    ...
    void setUp() {
        ...
        vetoGateway = new VetoGateway(config, llamaCppBridge, semanticRedactor,
            grammarEngine, auditLogger);
    }
    ...
    void testProcessOutboundPassesCleanData() {
        ...
        VetoGateway.VetoResult result = vetoGateway.processOutbound(
            cleanPayload, "dag-1", "req-1", "C6-Sandbox");
    ...
    void testProcessOutboundRedactsIPs() {
        ...
        VetoGateway.VetoResult result = vetoGateway.processOutbound(
            payload, "dag-2", "req-2", "C6-Sandbox");
    ...
    void testProcessOutboundWithMultipleRedactions() {
        String payload = "IP: 192.168.1.1, Email: admin@internal.corp, Key: abcdefghijklmnopqrstuvwxyz0123456789ABCDEF";
        VetoGateway.VetoResult result = vetoGateway.processOutbound(
            payload, "dag-3", "req-3", "C4-MCP");
    ...
    void testDisablePassesEverything() {
        ...
        VetoGateway disabledGateway = new VetoGateway(disabledConfig, llamaCppBridge,
            semanticRedactor, grammarEngine, auditLogger);

        String sensitivePayload = "Secret: my-api-key-12345";
        VetoGateway.VetoResult result = disabledGateway.processOutbound(
            sensitivePayload, "dag-4", "req-4", "C6-Sandbox");
