...
class ToolExecutionRequestTest {
    ...
    void testRequiredCredentials() {
        ToolExecutionRequest req = new ToolExecutionRequest(
            "id1", "compile_cpp", Map.of("file", "x.cpp"),
            Set.of("ssh-key-1", "api-token"), "sess1", "wf1");
    ...
    void testEqualityById() {
        ToolExecutionRequest r1 = new ToolExecutionRequest(
            "same-id", "cap1", Map.of(), Set.of(), "", "");
        ToolExecutionRequest r2 = new ToolExecutionRequest(
            "same-id", "cap2", Map.of(), Set.of(), "", "");
        assertEquals(r1, r2);
